	...
	<div class="modal-example-form {cBase}">
	  ...
	  <form class="modal-form {cForm}">
		...
		<label class="label">
		  ...
		  <input class="input" type="tel" bind:value={formData.phone} placeholder="Enter phone..." />
		</label>
		<label class="label">
		  <span>Email</span>
		...
		<label class="flex items-center space-x-2">
		  <input class="radio" type="radio" checked name="radio-direct" value=true bind:group={formData.waiver}/>
		  <p>Waiver (signed)</p>
		</label>
		<label class="flex items-center space-x-2">
